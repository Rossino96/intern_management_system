        ...
        <form action="{{ route('stagiaires.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                <div class="form-group">
                    ...
                    <input class="form-control" name="nom" value="{{ old('nom') }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="prenom" value="{{ old('prenom') }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control"
                        name="etablissement" value="{{ old('etablissement') }}">
                    </div>
